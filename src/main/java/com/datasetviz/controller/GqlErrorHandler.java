...
import com.datasetviz.service.CancelledException;
...
@Component
public class GqlErrorHandler extends DataFetcherExceptionResolverAdapter {

    @Override
    protected GraphQLError resolveToSingleError(Throwable exception, DataFetchingEnvironment environment) {
        if (exception instanceof CancelledException || exception instanceof IllegalArgumentException) {
