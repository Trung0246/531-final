...
class ServiceInternalsCoverageTest {
    ...
    void csvServicePrivateMethodsCoverRemainingBranches() throws Exception {
        ...
        analyticsProps.setMaxFilesHardLimit(10);
        CsvService service = new CsvService(mock(RegistryService.class), mock(HdfsStore.class), analyticsProps);

        assertThat(invoke(service, "fileLimit", new Class[]{Integer.class}, 0)).isEqualTo(5);
        assertThat(invoke(service, "fileLimit", new Class[]{Integer.class}, 99)).isEqualTo(10);
        assertThat(invoke(service, "normHeader", new Class[]{String.class}, new Object[]{null})).isEqualTo("");

        assertThat(invokeStatic(CsvService.class, "parseDate", new Class[]{String.class}, "2020-01-01T10:15:30Z[UTC]")).isEqualTo(Optional.of(LocalDate.parse("2020-01-01")));
        assertThat(invokeStatic(CsvService.class, "parseDate", new Class[]{String.class}, "2020-01-01T10:15:30+02:00")).isEqualTo(Optional.of(LocalDate.parse("2020-01-01")));
        assertThat(invokeStatic(CsvService.class, "parseDate", new Class[]{String.class}, "2020-01-01T10:15:30")).isEqualTo(Optional.of(LocalDate.parse("2020-01-01")));
        assertThat(invokeStatic(CsvService.class, "parseDate", new Class[]{String.class}, "2020-01-01 extra")).isEqualTo(Optional.of(LocalDate.parse("2020-01-01")));
        assertThat(invokeStatic(CsvService.class, "parseDate", new Class[]{String.class}, "   ")).isEqualTo(Optional.empty());
        assertThat(invokeStatic(CsvService.class, "parseDate", new Class[]{String.class}, "nope")).isEqualTo(Optional.empty());
        assertThat(invokeStatic(CsvService.class, "parseNum", new Class[]{String.class}, "   ")).isEqualTo(Optional.empty());
        ...
        assertThat(invokeStatic(CsvService.class, "resolveLocation", new Class[]{CSVRecord.class, String.class}, blankRecord, null)).isNull();
        CSVRecord blankLocationRecord = csvRecords("Location\n \n").get(0);
        assertThat(invokeStatic(CsvService.class, "resolveLocation", new Class[]{CSVRecord.class, String.class}, blankLocationRecord, "Location")).isNull();

        Class<?> fileSchemaClass = Class.forName("com.datasetviz.service.CsvService$FileSchema");
        ...
        Class<?> mutableAnalyticsClass = Class.forName("com.datasetviz.service.CsvService$MutableAnalytics");
    ...
    void emailAnalyticsMutableAnalyticsCoversNormalizationAndDateComparisons() throws Exception {
        Class<?> mutableAnalyticsClass = Class.forName("com.datasetviz.service.EmailService$MutableAnalytics");
