...
class ModelAndDtoTest {
    ...
    void csvModelsAndDtosRoundTrip() {
        ...
        hdfsProps.setUri("hdfs://custom:9000");
        hdfsProps.setUser("user");
        hdfsProps.setConfiguration(Map.of("k", "v"));
        assertThat(hdfsProps.getUri()).isEqualTo("hdfs://custom:9000");
        assertThat(hdfsProps.getUser()).isEqualTo("user");
        assertThat(hdfsProps.getConfiguration()).containsEntry("k", "v");
